...
export async function getAllProperties(filters) {
    let { title, minPrice, maxPrice, city, region, country, amenities, status, page = 1, limit = 10, sortBy = "createdAt", sortOrder = "desc", } = filters;
    const where = {};
    if (title) {
...
export async function generatePresignedUrl(fileTypes, folder) {
    const results = [];
...
export async function getFileUrl(fileKeys) {
