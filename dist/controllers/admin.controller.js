...
//         const newAdminWithoutPassword = { ...newAdmin.toObject(), password: undefined };
//         await newAdmin.save();
...
//     }
// };
// export const loginAdmin = async (req: LoginAdminRequest, res: Response) => {
...
//             data: { token, user: newAdminWithoutPassword }
//         });
//     } catch (error) {
...
//             existingAdmin.resetTokenExpiry = new Date(Date.now() + 10 * 60 * 1000);
...
//             });
//         }
//         if (Date.now() > (existingAdmin.resetTokenExpiry?.getTime() || 0)) {
//             return res.status(400).json({
//                 success: false,
...
//         }
//         const hashedCode = hmacProcess(resetTokenCode, process.env.HMAC_SECRET_CODE!);
//         if (hashedCode === existingAdmin.resetTokenCode && Date.now() <= (existingAdmin.resetTokenExpiry?.getTime() || 0)) {
//             existingAdmin.resetTokenCode = undefined;
